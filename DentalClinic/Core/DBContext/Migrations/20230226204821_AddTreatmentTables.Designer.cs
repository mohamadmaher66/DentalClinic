...
namespace DBContext.Migrations
{
    ...
    [Migration("20230226204821_AddTreatmentTables")]
    partial class AddTreatmentTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBModels.AppointmentTreatment", b =>
                {
                    b.Property<int>("AppointmentId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DBModels.Treatment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DBModels.AppointmentTreatment", b =>
                {
                    b.HasOne("DBModels.Appointment", "Appointment")
                        .WithMany("AppointmentTreatmentList")
                        .HasForeignKey("AppointmentId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DBModels.Treatment", "Treatment")
                        .WithMany("AppointmentTreatmentList")
